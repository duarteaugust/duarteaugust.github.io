...
function sortearDirecaoX(){
  ...
  console.log("limiteDireito: "+limiteDireito + "| numDirecaoX" + numDirecaoX)
  return numDirecaoX;
}
...
function sortearDirecaoY(){
  ...
  //console.log("limiteInferior: "+ limiteInferior + "| numDirecaoY: "+ numDirecaoY)
  return numDirecaoY;
}
...
function criarOuvinte (bola){
  //console.log("bola: " + bola);
   ...
   /* $(bola).dblclick(function() {
      alert( "click duplo não vale!" );
    });*/
}
